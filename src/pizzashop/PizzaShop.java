...
/**
 * Review class for Final Exam Part D review. Creates a pizza of a given type and cuts it 
 * into slices. Note that the following source was used as a reference in creating this 
 * example: Freeman, E.Freeman, E., Sierra, K., & Bates, B. (2004). 
